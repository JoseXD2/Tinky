function onCreate()
    ...
    makeLuaSprite('Stage3', 'empanadas/bgg', -650, -280);
    setScrollFactor('Stage3', 1, 1)
    scaleObject('Stage3', 1, 1)
    addLuaSprite('Stage3', false); 

    makeLuaSprite('Stage2', 'empanadas/threes', -650, -280);
    ...
    scaleObject('chichadialog1', 0.5, 0.5)
    ...
    scaleObject('chichadialog2', 0.5, 0.5)
    ...
    scaleObject('Benitodialog', 0.5, 0.5)
    ...
    scaleObject('Benitodialog2', 0.5, 0.5)
